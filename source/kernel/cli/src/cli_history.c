...
static GT_UI8 cmd_history[CLI_MAX_CMD_HISTORY][CLI_MAX_CMD_LEN+1];

/* history default start from 0,
 * always point to the last empty history space.
 */
static GT_UI8 n_cmd_history;

/* current history number */
static GT_UI8 current_history;
...
******************************************************************************/
GT_BOOL CLI_HISTORY_AddHistory(IN const GT_UI8 *history)
{
 ...
 *      Ver1.00     2007.02.14      Panda Xiong         Create
******************************************************************************/
GT_UI8 *CLI_HISTORY_GetNextHistory(void)
{
 ...
 *      Ver1.00     2007.02.14      Panda Xiong         Create
******************************************************************************/
GT_UI8 *CLI_HISTORY_GetPrevHistory(void)
{
