 ...
 */
static CLI_REG_CMD_S *p_cmd_end = NULL;
...
)
{
    ...
    CLI_REG_CMD_S *last_matched_cmd;
    GT_U32         least_matched_len;
    GT_U32         loop;
